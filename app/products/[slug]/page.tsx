...
import food from "../../../public/assets/Img/cooking-1013455_1920.webp";
      ...
      <div className="flex flex-col lg:flex-row +bg-white bg-opacity-80 backdrop-blur-md rounded-lg shadow-lg p-6">
        <div className="lg:w-1/2">
          <div className="my-10 md:flex md:justify-center sm:flex sm:justify-center">
            <Image
              src={product.primaryImage?.URLs?.original || food}
        ...
        <div className="lg:w-1/2 p-5 flex flex-col space-y-7 self-center">
          <h1 className="text-3xl mb-2 font-bold">{product.title}</h1>
          ...
          <button className="bg-black text-white text-2xl px-4 py-2 w-full rounded">
            Add to cart
          </button>
        </div>
      </div>
